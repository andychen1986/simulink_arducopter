...
simIn.param.AHRS.FC2BF = single(angle2dcm(trim_x, trim_y, 0)); % Rotation matrix from FC to Body Frame based on AP_AHRS constructor
...
simIn.init.ATT.DCM = angle2dcm(rollAngInit, pitchAngInit, yawAngInit);
